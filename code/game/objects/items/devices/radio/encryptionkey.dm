...
/obj/item/device/encryptionkey/headset_medsci
	...
	channels = list("Medicae" = 1, "Biologis" = 1)
...
/obj/item/device/encryptionkey/heads/captain
	...
	channels = list("Command" = 1, "Militarum" = 1, "Biologis" = 0, "Medicae" = 0, "Machinarum" = 0, "Service" = 0, "Hailing" = 0)
...
/obj/item/device/encryptionkey/heads/hos
	...
	channels = list("Militarum" = 1, "Command" = 1, "Hailing" = 1)
...
/obj/item/device/encryptionkey/ert
	...
	channels = list("Response Team" = 1, "Biologis" = 1, "Command" = 1, "Medicae" = 1, "Mechanicus" = 1, "Militarum" = 1, "Machinarum" = 1, "Service" = 1, "Hailing" = 1)
