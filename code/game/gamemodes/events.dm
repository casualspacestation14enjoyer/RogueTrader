...
*/
	...
	for(var/mob/living/silicon/ai/M in GLOB.alive_mobs)
		if(M.stat != 2 && M.see_in_dark != 0)
			...
			var/target = pick("a traitor", "a heretic agent", "a changeling", "a wizard", "the head of a revolution", "Soviet spy", "a good person", "a dwarf", "an elf", "a fairy princess", "the captain", "Beepsky", "God", "a pirate", "a gryphon", "a chryssalid")
