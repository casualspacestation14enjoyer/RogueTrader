...
#define SECURITY_ROLES list(/datum/job/guard_captain, /datum/job/enforcer_sergeant, /datum/job/xeno_mercenary, /datum/job/enforcer)
...
#define ARMED_ROLES list(/datum/job/rogue_trader, /datum/job/seneschal, /datum/job/rd, /datum/job/magos_biologis, /datum/job/magos_explorator, /datum/job/guard_captain, /datum/job/sea, /datum/job/enforcer, /datum/job/enforcer_sergeant, /datum/job/xeno_mercenary, /datum/job/merchant, /datum/job/submap/scavver_pilot, /datum/job/submap/scavver_doctor, /datum/job/submap/scavver_engineer)

//For jobs that spawn with armor in their lockers
#define ARMORED_ROLES list(/datum/job/rogue_trader, /datum/job/seneschal, /datum/job/rd, /datum/job/magos_biologis, /datum/job/magos_explorator, /datum/job/guard_captain, /datum/job/noble_guest, /datum/job/sea, /datum/job/enforcer, /datum/job/enforcer_sergeant, /datum/job/xeno_mercenary, /datum/job/merchant, /datum/job/submap/skrellscoutship_crew, /datum/job/submap/skrellscoutship_crew/leader, /datum/job/submap/scavver_pilot, /datum/job/submap/scavver_doctor, /datum/job/submap/scavver_engineer)
