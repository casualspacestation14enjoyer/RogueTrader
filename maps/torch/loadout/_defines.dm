...
#define ARMORED_ROLES list(/datum/job/rogue_trader, /datum/job/seneschal, /datum/job/rd, /datum/job/magos_biologis, /datum/job/magos_explorator, /datum/job/guard_captain, /datum/job/noble_guest, /datum/job/sea, /datum/job/enforcer, /datum/job/enforcer_sergeant, /datum/job/guardsman, /datum/job/merchant, /datum/job/submap/skrellscoutship_crew, /datum/job/submap/skrellscoutship_crew/leader, /datum/job/submap/scavver_noble, /datum/job/submap/scavver_crew, /datum/job/submap/scavver_engineer)
