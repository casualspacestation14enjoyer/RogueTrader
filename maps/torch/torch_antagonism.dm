...
/datum/antagonist/changeling
	...
	restricted_jobs = list(/datum/job/novitiate, /datum/job/bondsman, /datum/job/medicae)
...
/datum/antagonist/loyalists
	...
	restricted_jobs = list(/datum/job/enforcer, /datum/job/novitiate, /datum/job/bondsman, /datum/job/medicae)

/datum/antagonist/revolutionary
	blacklisted_jobs = list(/datum/job/ai, /datum/job/cyborg, /datum/job/submap, /datum/job/merchant)
	restricted_jobs = list(/datum/job/rogue_trader, /datum/job/seneschal, /datum/job/enforcer, /datum/job/novitiate, /datum/job/bondsman, /datum/job/medicae)

/datum/antagonist/traitor
	blacklisted_jobs = list(/datum/job/merchant, /datum/job/rogue_trader, /datum/job/seneschal, /datum/job/ai, /datum/job/submap, /datum/job/guard_captain, /datum/job/novitiate, /datum/job/bondsman, /datum/job/medicae)
