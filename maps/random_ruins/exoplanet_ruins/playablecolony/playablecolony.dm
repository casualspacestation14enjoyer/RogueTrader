...
/datum/map_template/ruin/exoplanet/playablecolony
	...
	force_ruins = list(/datum/map_template/ruin/exoplanet/crashed_ship)
...
/singleton/submap_archetype/playablecolony
	...
	crew_jobs = list(/datum/job/submap/colonist, /datum/job/submap/colonist_noble)

/datum/job/submap/colonist_noble
	title = "Landed Paladin"
	supervisors = "the trust of your fellow Colonists"
	info = "You are a Colonist, living on the rim of explored, let alone inhabited, space in a recently forged colonial settlement."
	total_positions = 0
...
/datum/job/submap/colonist_noble/equip(mob/living/carbon/human/H)
	...
	if(current_title == "Landed Paladin" || current_title == "Mercenary" || current_title == "Bounty Hunter" || current_title == "Deserter")
		if(current_title == "Landed Paladin")
...
/datum/job/submap/colonist/equip(mob/living/carbon/human/H)
	...
	if(current_title && (H.mind.role_alt_title in alt_titles))
		...
		current_title = title // use default title
	if(current_title == "Landed Colonist" || current_title == "Tribal" || current_title == "Pathfinder" || current_title == "Miner" || current_title == "Heretek")
		if(current_title == "Landed Colonist")
...
/singleton/hierarchy/outfit/job/colonist
	name = OUTFIT_JOB_NAME("Landed Colonist")
	id_types = null
	pda_type = null
