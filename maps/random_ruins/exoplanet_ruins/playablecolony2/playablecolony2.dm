...
/singleton/submap_archetype/playablecolony2
	...
	crew_jobs = list(/datum/job/submap/colonist2_noble, /datum/job/submap/colonist2)
...
/datum/job/submap/colonist2/equip(mob/living/carbon/human/H)
	...
	if(current_title && (H.mind.role_alt_title in alt_titles))
		...
		current_title = title // use default title
	if(current_title == "Ship Colonist" || current_title == "Tribal" || current_title == "Pathfinder" || current_title == "Miner" || current_title == "Heretek")
		if(current_title == "Ship Colonist")
